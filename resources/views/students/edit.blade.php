                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-2">
                                    ...
                                    <select id="inputState" class="form-select" name="gender" required>
                                        <option value="Laki-laki" {{($student->gender == 'Laki-laki')?'selected':null}}>Laki-laki</option>
                                        <option value="Perempuan" {{($student->gender == 'Perempuan')?'selected':null}}>Perempuan</option>
                                    </select>
                                </div>
                                <div class="col-2">
